...
import com.dev.ghazi.sunshine.data.WeatherDbHelper;
...
public class TestProvider extends AndroidTestCase {
    ...
    public void testInsertReadProvider() {
        ...
        long locationRowId;
        Uri locationUri = getContext().getContentResolver().insert(LocationEntry.CONTENT_URI, testValues);
        ...
        long weatherRowId;
        Uri weatherUri = getContext().getContentResolver().insert(WeatherEntry.CONTENT_URI, weatherValues);
        weatherRowId = ContentUris.parseId(weatherUri);
