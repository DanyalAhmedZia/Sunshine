package com.dev.ghazi.sunshine.sync;
...
import com.dev.ghazi.sunshine.BuildConfig;
import com.dev.ghazi.sunshine.MyActivity;
import com.dev.ghazi.sunshine.R;
import com.dev.ghazi.sunshine.Utility;
    ...
    private void notifyWeather() {
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst()) {
                ...
                notificationManager.notify(WEATHER_NOTIFICATION_ID, compatBuilder.build());
