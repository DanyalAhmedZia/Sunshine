package com.dev.ghazi.sunshine.data;
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case WEATHER_WITH_LOCATION_AND_DATE:
            {
                ...
                selectionArgs = new String[]{WeatherContract.WeatherEntry.getLocationSettingFromUri(uri), WeatherContract.WeatherEntry.getDateFromUri(uri)};
            ...
            case LOCATION_ID: {
                ...
                selectionArgs[0]=Long.toString(ContentUris.parseId(uri));
                retCursor = mOpenHelper.getReadableDatabase().query(
                        WeatherContract.LocationEntry.TABLE_NAME,
                        projection,
                        selection,
